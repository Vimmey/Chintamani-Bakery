...
{
$cno=$r1['c_no'];
$q1="select * from cake where c_no=$cno";
$rs=mysql_query($q1);
...
?>
                    ...
                    <tr class="dmtmenu-item">
							<td>
								...
								<h5><span>
								<a rel="lightbox[1]" href="<?php echo $r['c_img'];?>" title="<?php echo $r['c_name'];?>">
									<img src="images/eye.png"class="icon"/><?php echo $r['c_name'];?></a></span></h5>
								<details class="small">

									<p><?php echo $r['c_detail'];?></p>
								</details>
							</td>
							<td class="dmtmenu-price"><a href="index1.php"><img src="images/cart.png" alt="" class="icon" /></a><?php echo $r['c_price'];?></td>
						</tr>
