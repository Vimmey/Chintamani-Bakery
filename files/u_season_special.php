...
{
$ssno=$r1['ss_no'];
$q1="select * from season where ss_no=$ssno";
$rs=mysql_query($q1);
...
?>
                    ...
                    <tr class="dmtmenu-item">
							<td>
								...
								<h5><span>
					<a rel="lightbox[1]" href="<?php echo $r['ss_img'];?>" title="<?php echo $r['ss_name'];?>">
									<img src="images/eye.png" alt="" class="icon" /><?php echo $r['ss_name'];?></a></span></h5>

									<p><?php echo $r['ss_detail'];?></p>
								</details>
							</td>
							<td class="dmtmenu-price"><a href="index1.php"><img src="images/cart.png" alt="" class="icon" /></a><?php echo $r['ss_price'];?></td>
						</tr>
