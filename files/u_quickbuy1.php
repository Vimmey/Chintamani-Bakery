...
?>
							...
							<li>
                                <a rel="lightbox" href="u_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>" title="<?php echo $r['qb_name'];?>">
									<a href="u_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>"><img width="270" height="220" src="<?php echo $r['qb_img'];?>"" alt="Image Title" /></a>
                                    <div class="text">
                                    <p>
					<a href="u_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>"><?php echo $r['qb_name'];
					echo "<br>"
					?>
                    </a>
