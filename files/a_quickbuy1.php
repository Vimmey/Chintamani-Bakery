			...
			<div id="nav">
				...
				<nav class="jquery-menu clearfix">
					<ul class="menu">
						...
						<li class="current active parent"><a href="a_menu.php">Menu</a>
							<ul>
...
?>
							...
							<li>
                                <a rel="lightbox" href="a_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>" title="<?php echo $r['qb_name'];?>">
									<a href="a_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>"><img width="270" height="220" src="<?php echo $r['qb_img'];?>"" alt="Image Title" /></a>
                                    <div class="text">
                                    <p>
					<a href="a_quickbuy2.php?p_catg=<?php echo $r['p_category'];?>"><?php echo $r['qb_name'];
					echo "<br>"
					?>
                    </a>
...
?>			
	...
	<div class="clear left content">
			...
			<div class="right content">
				...
				<div class="small carte-footer">
					<form action="search11.php" method="post" id="search-form">
