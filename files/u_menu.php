			...
			<div id="nav">
				...
				<nav class="jquery-menu clearfix">
					<ul class="menu">
						...
						<li class="parent"><a href="u_menu.php">Menu</a>
							<ul>
...
{
$sno=$r1['s_no'];
$q1="select * from sweets where s_no=$sno";
$rs=mysql_query($q1);
...
?>
					<table class="fulltable">
						...
						<tr class="dmtmenu-item">
							<td>
								<h5><span>
                                <a rel="lightbox[1]" href="<?php echo $r['s_img'];?>" title="<?php echo $r['s_name'];?>">
									<img src="images/eye.png"class="icon"/><?php echo $r['s_name'];?></a></span></h5>
								<details class="small">

									<p><?php echo $r['s_detail'];?></p>
								</details>
							</td>
							<td class="dmtmenu-price"></a><?php echo $r['s_price'];?></td>
						</tr>
