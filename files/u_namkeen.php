...
session_start();
include('connM.php');
$q="select * from namkeen";
$rs1=mysql_query($q);
while($r1=mysql_fetch_assoc($rs1))
{
$nno=$r1['n_no'];
$q1="select * from namkeen where n_no=$nno";
$rs=mysql_query($q1);
...
?>
                    ...
                    <tr class="dmtmenu-item">
							<td>
								...
								<h5><span>
					<a rel="lightbox[1]" href="<?php echo $r['n_img'];?>" title="<?php echo $r['n_name'];?>">
									<img src="images/eye.png" alt="" class="icon" /><?php echo $r['n_name'];?></a></span></h5>

									
								</details>
							</td>
							<td class="dmtmenu-price"><a href="index1.php"><img src="images/cart.png" alt="" class="icon" /></a><?php echo $r['n_price'];?></td>
						</tr>
			...
			<div class="sidebar content">
				...
				<div class="module">
					...
					<p><a class="thumbnail" href="img/chocolate_burfi.jpg" rel="lightbox[0]" title="Maecenas a purus risus">
						...
						<img class="caption left" src="img/Sweets/chocolate_burfi.jpg" border="0" title="" width="165" height="109" /></a>
					<h3>Ingredients</h3>
