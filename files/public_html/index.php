...
<!--[if !IE]><!--> <body> <!--<![endif]-->
	...
	<header id="header" class="clearfix">
		...
		<div class="wrap">
            ...
            <form method="post" action="register.php" style="margin-left:500px; margin-top:20px; height:80px;">
 New to this Website?            
<button type="submit" name="1">Register Yourself!</button>
            </form>
 <!--<p><a class="make-me-btn" href="menu.php">Register Yourself!</a></p>-->
			 <div id="nav">
